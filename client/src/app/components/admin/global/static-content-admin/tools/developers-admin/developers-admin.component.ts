...
@Component({
	selector: 'app-developers-admin',
	templateUrl: './developers-admin.component.html',
	styleUrls: ['./developers-admin.component.css']
})
export class DevelopersAdminComponent implements OnInit {
