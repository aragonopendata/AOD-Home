...
@Component({
	selector: 'app-sparql-admin',
	templateUrl: './sparql-admin.component.html',
	styleUrls: ['./sparql-admin.component.css']
})
export class SparqlAdminComponent implements OnInit {
